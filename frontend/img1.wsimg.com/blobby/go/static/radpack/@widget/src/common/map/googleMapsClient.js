...
class GoogleMapsClient extends React.Component {
        constructor(props) {
            ...
            this.state = {
                ...
                isViewPortRender: props.viewDevice === 'MOBILE_RENDER_DEVICE' && !!document.querySelector('.device-chrome'),
                ...
                return ( <
                    ...
                    } >
                    {
                        ...
                        /div> {
                            ...
                            /> } {
                                showMobileOverlay && ( <
                                    FullScreenOverlay getDirectionsLabel = {
                                        staticContent.mapCTA
                                    }
                                    renderMap = {
